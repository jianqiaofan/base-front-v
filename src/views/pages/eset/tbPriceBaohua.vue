  ...
  <div class="app-container">
    ...
    <div class="tools-div">
      <el-button type="success" icon="el-icon-plus" size="mini" @click="add"
                 :disabled="$hasBP('bnt.tbPriceBaohua.add')  === false"
      >添 加
      </el-button>
      <el-button style="margin-left:8px" size="mini" :disabled="$hasBP('bnt.tbPriceBaohua.list')  === false" type="primary"
                 @click="exportData"
      >导出数据
      </el-button>
    </div>
      ...
      <el-table-column label="操作" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button type="primary" icon="el-icon-edit" size="mini" @click="edit(scope.row.id)"
                     :disabled="$hasBP('bnt.tbPriceBaohua.update')  === false" title="修改"
          />
          <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeDataById(scope.row.id)"
                     :disabled="$hasBP('bnt.tbPriceBaohua.remove')  === false" title="删除"
          />
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog title="添加/修改" :visible.sync="dialogVisible" width="40%" :close-on-click-modal="false">
      <el-form ref="dataForm" :model="tbPriceBaohua" :rules="rules" label-width="100px" size="small"
               style="padding-right: 40px;"
      >
        <el-form-item label="生产地" prop="site">
          <el-select v-model="tbPriceBaohua.site" placeholder="请选择生产地">
            <el-option value="国内">国内生产</el-option>
            <el-option value="沙特">沙特吉达</el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="材料厚度" prop="thickness"><el-input v-model="tbPriceBaohua.thickness" /></el-form-item>
        <el-form-item label="S350" prop="rawPrice350"><el-input v-model="tbPriceBaohua.rawPrice350" /></el-form-item>
        <el-form-item label="S420" prop="rawPrice420"><el-input v-model="tbPriceBaohua.rawPrice420" /></el-form-item>
        <el-form-item label="S450" prop="rawPrice450"><el-input v-model="tbPriceBaohua.rawPrice450" /></el-form-item>
        <el-form-item label="S550" prop="rawPrice550"><el-input v-model="tbPriceBaohua.rawPrice550" /></el-form-item>

        <el-form-item label="镀锌275" prop="galvanizing275"><el-input v-model="tbPriceBaohua.galvanizing275" /></el-form-item>
        <el-form-item label="镀锌310" prop="galvanizing310"><el-input v-model="tbPriceBaohua.galvanizing310" /></el-form-item>
        <el-form-item label="镀锌350" prop="galvanizing350"><el-input v-model="tbPriceBaohua.galvanizing350" /></el-form-item>
        <el-form-item label="镀锌450" prop="galvanizing450"><el-input v-model="tbPriceBaohua.galvanizing450" /></el-form-item>
        <el-form-item label="镀锌475" prop="galvanizing475"><el-input v-model="tbPriceBaohua.galvanizing475" /></el-form-item>

        <el-form-item label="主梁利用率" prop="utilizationRateBeam"><el-input v-model="tbPriceBaohua.utilizationRateBeam" /></el-form-item>
        <el-form-item label="檩条利用率" prop="utilizationRatePurlin"><el-input v-model="tbPriceBaohua.utilizationRatePurlin" /></el-form-item>
        <el-form-item label="主梁加工费" prop="processingFeeBeam"><el-input v-model="tbPriceBaohua.processingFeeBeam" /></el-form-item>
        <el-form-item label="檩条加工费" prop="processingFeePurlin"><el-input v-model="tbPriceBaohua.processingFeePurlin" /></el-form-item>
        <el-form-item label="主梁包装费" prop="packagingFee"><el-input v-model="tbPriceBaohua.packagingFeeBeam" /></el-form-item>
        <el-form-item label="檩条包装费" prop="packagingFee"><el-input v-model="tbPriceBaohua.packagingFeePurlin" /></el-form-item>
        <!--        <el-form-item label="出口退税" prop="exportTaxRebate"><el-input v-model="tbPriceBaohua.exportTaxRebate"/></el-form-item>-->
        <!--        <el-form-item label="进口关税" prop="importTariff"><el-input v-model="tbPriceBaohua.importTariff"/></el-form-item>-->
        <!--        <el-form-item label="海运费" prop="oceanFreight"><el-input v-model="tbPriceBaohua.oceanFreight"/></el-form-item>-->
...
import api from '@/api/eset/tbPriceBaohua'
...
export default {
  ...
  methods: {
    ...
    //导出数据
    exportData() {
      window.open(process.env.VUE_APP_BASE_API + '/eset/tbPriceBaohua/export?token=' + getToken())
    },
    // 每页数
    ...
    edit(id) {
      ...
      api.getById(id).then(response => {
        this.$nextTick(function() {
          this.tbPriceBaohua = response.data
          if (this.$refs.zdept) {
            this.$refs.zdept.reset_data(this.tbPriceBaohua.deptName)
          }
          if (this.$refs.eltreeDept) {
            this.$refs.eltreeDept.setCheckedKeys(this.tbPriceBaohua.deptIdList)
          }
        })
      })
    },
    ...
    //添加
    save() {
      api.save(this.tbPriceBaohua).then(response => {
    ...
    //更新
    update() {
      api.updateById(this.tbPriceBaohua).then(response => {
