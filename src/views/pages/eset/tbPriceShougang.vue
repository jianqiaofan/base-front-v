  ...
  <div class="app-container">
    ...
    <div class="tools-div">
      <el-button type="success" icon="el-icon-plus" size="mini" @click="add"
                 :disabled="$hasBP('bnt.tbPriceShougang.add')  === false"
      >添 加
      </el-button>
      <el-button style="margin-left:8px" size="mini" :disabled="$hasBP('bnt.tbPriceShougang.list')  === false" type="primary"
                 @click="exportData"
      >导出数据
      </el-button>
    </div>
      ...
      <el-table-column label="操作" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button type="primary" icon="el-icon-edit" size="mini" @click="edit(scope.row.id)"
                     :disabled="$hasBP('bnt.tbPriceShougang.update')  === false" title="修改"
          />
          <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeDataById(scope.row.id)"
                     :disabled="$hasBP('bnt.tbPriceShougang.remove')  === false" title="删除"
          />
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog title="添加/修改" :visible.sync="dialogVisible" width="40%" :close-on-click-modal="false">
      <el-form ref="dataForm" :model="tbPriceShougang" :rules="rules" label-width="100px" size="small"
               style="padding-right: 40px;"
      >
        <el-form-item label="生产地" prop="site">
          <el-select v-model="tbPriceShougang.site" placeholder="请选择生产地">
            <el-option value="国内">国内生产</el-option>
            <el-option value="沙特">沙特吉达</el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="材料厚度" prop="thickness"><el-input v-model="tbPriceShougang.thickness" /></el-form-item>
        <el-form-item label="S350" prop="rawPrice350"><el-input v-model="tbPriceShougang.rawPrice350" /></el-form-item>
        <el-form-item label="S420" prop="rawPrice420"><el-input v-model="tbPriceShougang.rawPrice420" /></el-form-item>
        <el-form-item label="S450" prop="rawPrice450"><el-input v-model="tbPriceShougang.rawPrice450" /></el-form-item>
        <el-form-item label="S550" prop="rawPrice550"><el-input v-model="tbPriceShougang.rawPrice550" /></el-form-item>

        <el-form-item label="镀锌275" prop="galvanizing275"><el-input v-model="tbPriceShougang.galvanizing275" /></el-form-item>
        <el-form-item label="镀锌310" prop="galvanizing310"><el-input v-model="tbPriceShougang.galvanizing310" /></el-form-item>
        <el-form-item label="镀锌350" prop="galvanizing350"><el-input v-model="tbPriceShougang.galvanizing350" /></el-form-item>
        <el-form-item label="镀锌450" prop="galvanizing450"><el-input v-model="tbPriceShougang.galvanizing450" /></el-form-item>
        <el-form-item label="镀锌475" prop="galvanizing475"><el-input v-model="tbPriceShougang.galvanizing475" /></el-form-item>

        <el-form-item label="主梁利用率" prop="utilizationRateBeam"><el-input v-model="tbPriceShougang.utilizationRateBeam" /></el-form-item>
        <el-form-item label="檩条利用率" prop="utilizationRatePurlin"><el-input v-model="tbPriceShougang.utilizationRatePurlin" /></el-form-item>
        <el-form-item label="主梁加工费" prop="processingFeeBeam"><el-input v-model="tbPriceShougang.processingFeeBeam" /></el-form-item>
        <el-form-item label="檩条加工费" prop="processingFeePurlin"><el-input v-model="tbPriceShougang.processingFeePurlin" /></el-form-item>
        <el-form-item label="主梁包装费" prop="packagingFee"><el-input v-model="tbPriceShougang.packagingFeeBeam" /></el-form-item>
        <el-form-item label="檩条包装费" prop="packagingFee"><el-input v-model="tbPriceShougang.packagingFeePurlin" /></el-form-item>
        <!--        <el-form-item label="出口退税" prop="exportTaxRebate"><el-input v-model="tbPriceShougang.exportTaxRebate"/></el-form-item>-->
        <!--        <el-form-item label="进口关税" prop="importTariff"><el-input v-model="tbPriceShougang.importTariff"/></el-form-item>-->
        <!--        <el-form-item label="海运费" prop="oceanFreight"><el-input v-model="tbPriceShougang.oceanFreight"/></el-form-item>-->
...
import api from '@/api/eset/tbPriceShougang'
...
export default {
  ...
  methods: {
    ...
    //导出数据
    exportData() {
      window.open(process.env.VUE_APP_BASE_API + '/eset/tbPriceShougang/export?token=' + getToken())
    },
    // 每页数
    ...
    edit(id) {
      ...
      api.getById(id).then(response => {
        this.$nextTick(function() {
          this.tbPriceShougang = response.data
          if (this.$refs.zdept) {
            this.$refs.zdept.reset_data(this.tbPriceShougang.deptName)
          }
          if (this.$refs.eltreeDept) {
            this.$refs.eltreeDept.setCheckedKeys(this.tbPriceShougang.deptIdList)
          }
        })
      })
    },
    ...
    //添加
    save() {
      api.save(this.tbPriceShougang).then(response => {
    ...
    //更新
    update() {
      api.updateById(this.tbPriceShougang).then(response => {
